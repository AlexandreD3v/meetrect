...
/**
 * \file    test/phpunit/MeetrectFunctionalTest.php
 * \ingroup meetrect
 ...
 *
 * @package Testmeetrect
 */
class MeetrectFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/meetrect/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('meetrect/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/meetrect/admin/about.php');
		$this->authenticate();
		return $this->assertContains('meetrect/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('meetrectwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMeetrect_MeetrectTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMeetrect_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
